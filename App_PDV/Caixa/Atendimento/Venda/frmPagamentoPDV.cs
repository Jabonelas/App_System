...
namespace App_PDV
{
    public partial class frmPagamentoPDV : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmPagamentoPDV(frmTelaInicialPDV _form)
        {
            InitializeComponent();
        ...
        {
            GridView view = grdPagamentos.MainView as GridView;
        ...
        private void SalvarMovimentacao()
        {
            try
            {
                using (UnitOfWork uow = new UnitOfWork())
                {
                    ...
                    tb_jornada _jornada = uow.GetObjectByKey<tb_jornada>(jornada.id_jornada);
                    ...
                    movimentacao.fk_tb_jornada = _jornada;
