...
namespace App_ERP.Cadastro.Ator
{
    public partial class uc_CadAtor : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public uc_CadAtor(frmTelaInicialERP _form, string _operacao, long _idAtor, int _tipoAtor)
        {
            InitializeComponent();
            ...
            cmbTipoAmbEmis.Properties.AddEnum<SEnNfeTipoAmb>();
            cnbRegimeTribu.Properties.AddEnum<SEnNfeCodRegTrib>();
            cmbIndicadorInscEstad.Properties.AddEnum<SEnNfeIndInscEst>();
            ...
            if (_tipoAtor == 11)
            {
                abaFiscal.Visibility = LayoutVisibility.Always;
                abaRFB.Visibility = LayoutVisibility.Always;
            }
        }
        ...
        private void PreencherCampoAtorSelecionado()
        {
            try
            {
                using (UnitOfWork uow = new UnitOfWork())
                {
                    ...
                    cmbIndicadorInscEstad.EditValue = (SEnNfeIndInscEst)ator.at_nfeIndInscEst;
                    txtInscEstad.Text = ator.at_inscEst;
                    txtInscrEstdSubs.Text = ator.at_inscEstSubst;
                    txtInscSufra.Text = ator.at_inscSuframa;
                    cnbRegimeTribu.EditValue = (SEnNfeCodRegTrib)ator.at_nfeCodRegTrib;
                    ...
                    cmbTipoAmbEmis.EditValue = (SEnNfeTipoAmb)ator.at_nfeTipoAmb;
                }
            }
            catch (Exception ex)
            {
        ...
        private void FormatarTelaTipoAtor(int _tipoAtor)
        {
            switch (_tipoAtor)
            {
                case 1:
                    ...
                    lblTitulo.Text = "Cadastro de Consumidor";
                ...
                case 11:
                    ...
                    lblTitulo.Text = "Cadastro de Filial";
                ...
                case 30:
                    ...
                    lblTitulo.Text = "Cadastro de Transportadora";
                    //lblSubTitulo.Text = "Transportes cadastrados";
                    break;

                case 40:

                    lblTitulo.Text = "Cadastro de Intermediador";
        ...
        {
            _frmTelaInicial.TelaAtor(tipoAtor);
        }
        ...
        private long CadastroAtor()
        {
            try
            {
                using (UnitOfWork uow = new UnitOfWork())
                {
                    ...
                    var indicadorUnscricaoEstadual = cmbIndicadorInscEstad.EditValue == null ? 0 : (byte)(SEnNfeIndInscEst)cmbIndicadorInscEstad.EditValue;

                    var regimeTributario = cnbRegimeTribu.EditValue == null ? 0 : (byte)(SEnNfeCodRegTrib)cnbRegimeTribu.EditValue;

                    var tipoAmbienteEmissaoNfe = cmbTipoAmbEmis.EditValue == null ? 0 : (byte)(SEnNfeTipoAmb)cmbTipoAmbEmis.EditValue;
                    ...
                    ator.at_metaMensal = Convert.ToDecimal(txtMetaMensal.Text.Replace("R$", ""));
                    ator.at_manutPdv = 0;
                    ator.at_canc = 0;
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            _frmTelaInicial.TelaAtor(Convert.ToInt32(tipoAtor));
        }
