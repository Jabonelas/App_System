...
using tb_marca_produto = App_TelasCompartilhadas.bancoSQLite.tb_marca_produto;
using App_TelasCompartilhadas.Classes;

namespace App_ERP.Produto
{
    public partial class uc_CadProduto : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public uc_CadProduto(frmTelaInicialERP _form, string _operacao, long _idProduto)
        {
            InitializeComponent();
        ...
        private void uc_CadProd_Load(object sender, EventArgs e)
        {
        ...
        private void txtAjustGeralPreco_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            ValidarDigitos(sender, e);
        }

        private void txtAjustGeralPreco_KeyUp_1(object sender, KeyEventArgs e)
        {
