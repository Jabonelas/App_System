...
namespace App_ERP.Cadastro.Funcionario
{
    public partial class uc_CadFuncionario : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public uc_CadFuncionario(frmTelaInicialERP frm, string _operacao, long _idAtorFuncionario)
        {
            InitializeComponent();
            ...
            // Configurando o TextEdit para ser um campo de senha
            //textEditPassword.Properties.UseSystemPasswordChar = true;
            //textEditPassword.Properties.ShowStrengthIndicator = true;

            //----------------------------------------------------------------------------------------------------------------------------

            //// Configurando o TextEdit para campo de senha com ícone
            //textEditPassword.Properties.PasswordChar = '*';

            //// Adicionando um botão com ícone ao TextEdit
            //textEditPassword.Properties.Buttons.Add(new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Glyph));

            //// Carregando um ícone padrão do DevExpress
            //textEditPassword.Properties.Buttons[0].ImageOptions.Image = DevExpress.Images.ImageResourceCache.Default.GetImage("images/actions/show_16x16.png");

            //// Evento para alternar entre mostrar e ocultar senha
            //bool senhaVisivel = false;
            //textEditPassword.Properties.ButtonClick += (sender, e) => {
            //    senhaVisivel = !senhaVisivel;
            //    textEditPassword.Properties.PasswordChar = senhaVisivel ? '\0' : '*';
            //    textEditPassword.Properties.Buttons[0].ImageOptions.Image = senhaVisivel
            //        ? DevExpress.Images.ImageResourceCache.Default.GetImage("images/actions/hide_16x16.png")
            //        : DevExpress.Images.ImageResourceCache.Default.GetImage("images/actions/show_16x16.png");
            //};

            //----------------------------------------------------------------------------------------------------------------------------

            //// Configurando o TextEdit para campo de senha
            //buttonEdit1.Properties.PasswordChar = '*'; // Definindo o caractere de mascaramento

            //// Adicionando um ícone à direita do controle
            //buttonEdit1.Properties.Buttons.Add(new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Glyph));

            //// Carregando a imagem dos recursos do projeto ou de um arquivo
            //string caminhoIcone = @"C:\Users\israe\Downloads\configuracoes-da-web.png";
            //buttonEdit1.Properties.Buttons[0].ImageOptions.Image = Image.FromFile(caminhoIcone);

            //// Variável para controlar o estado (mostrar/ocultar senha)
            //bool senhaVisivel = false;

            //buttonEdit1.Properties.ButtonClick += (sender, e) =>
            //{
            //    senhaVisivel = !senhaVisivel;
            //    buttonEdit1.Properties.PasswordChar = senhaVisivel ? '\0' : '*'; // '\0' desativa o mascaramento

            //    // Alterando o ícone dependendo do estado de visibilidade
            //    buttonEdit1.Properties.Buttons[0].ImageOptions.Image = senhaVisivel
            //        ? Image.FromFile(caminhoIcone) // Ícone para mostrar senha
            //        : Image.FromFile(caminhoIcone); // Ícone para ocultar senha
            //};
        }
